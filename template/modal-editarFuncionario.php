<div class="modal fade campo_cadastro" id="modalEditarFuncionario" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form class="modal-content conteudo_modal" method="POST" action="editarFuncionario.php" onsubmit="fnValidarEnvioFuncionario(event)">
            ...
            <div class="modal-body">
                <div class="content cadastro">
                    ...
                    <input type="text" placeholder="Nome Completo" class="forms_cadastro_funcionario campoFuncionario mb-2 w-100 me-5" name="input_novo_nome_func" id="input_novo_nome_func" onblur="fnValidarCadastroFuncionario()" required>
